...
The whole project used "targets" pipeline. To run the project, install package "targets" in R using command "library(targets)" first and then run the command "tar_make()". All code should be executed automatically. If you have any problems, feel free to email shufan.w @ outlook.com.
